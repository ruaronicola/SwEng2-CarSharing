...
\def \worktimeNicola {17}
\def \worktimeGiacomo {17}
...
\begin{document}
	...
	\chapter{Integration strategy}
		\input{contents/Integration_Strategy}
    
    \newpage
    \chapter{Test case specifications}
    	\input{contents/test_case_specifications}
    
    \newpage
    \chapter{Test procedures}
    	\input{contents/test_procedures}
    
    \newpage
    \chapter{Tools and test equipment required}
    	\input{contents/Tools_and_test_equipment}
    
    \newpage
    \chapter{Program stubs and test data required}
    	\input{contents/Program_stubs_and_test_data_required}
