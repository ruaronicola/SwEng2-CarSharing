...
\begin{document}
    ...
    \section{Purpose}
		The aim of this project is to develop a digital management system called PowerEnJoy. That is a car-sharing service which uses only eletric-cars. The users have to be registered to the system, then they can use it and easily find the desidered car thanks to the location provided. The charge is automatically calculate by the system during the travel. For incentivize the virtuous behaviors of the users there are some discounts and some lots that can be applied to the bill.
