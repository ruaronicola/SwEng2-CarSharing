...
\begin{center}
  ...
  \begin{tabular}{|l|l|l|l|}
      ...
      3 & User & Manage account & G\ref{itm:goal-access} \\\hline
      ...
      7 & User & Use car & G\ref{itm:goal-locking} \\\hline
...
\subsection{Manage account}
  \input{contents/Requirements_Specification/System_Functions/Manage_account}
...
\newpage
\subsection{Use Car}
  \input{contents/Requirements_Specification/System_Functions/Use_Car}
...
\subsection{Discounts \& Fees}
   \input{contents/Requirements_Specification/System_Functions/Discounts_Fees}
