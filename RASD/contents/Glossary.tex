...
\newacronym{iOS}{iPhone Operating System}
\newacronym{WP}{Windows Phone}
\newacronym{OS}{Operating System}
\newacronym{ARM}{Advanced RISC Machine}
\newacronym{OBD}{On-Board Diagnostic System}
\newacronym{NDS}{Navigation Data Standard}
\newacronym{TMC}{Traffic Message Channel}
\newacronym{RDS}{Radio Data System}
\newacronym{LTE}{Long-Term Evolution}
\newacronym{JEE}{Java Platform, Enterprise Edition}
\newacronym{JVM}{Java Virtual Machine}
\newacronym{DBMS}{Database Managment System}
