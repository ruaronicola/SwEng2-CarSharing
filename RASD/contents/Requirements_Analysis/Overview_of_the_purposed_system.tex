...
\begin{itemize}
	...
	\item{If a vehicle is damaged during the ride becouse of the user, she is responsible for it}
	\item{If a vehicle is charging it's in a charging station}	
	
	\item{There are no time or distance limits for a single ride}
	\item{During a ride the number of passengers of a vehicle doesn't change}
